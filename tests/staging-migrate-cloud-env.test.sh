...
grep -F 'ACCOUNT_MANAGER_DOMAIN=account-manager.video-cloud-staging.realtekconnect.com' "$ENV_ROOT/env/stack.env" >/dev/null
grep -F 'CLOUD_ADMIN_DOMAIN=admin.video-cloud-staging.realtekconnect.com' "$ENV_ROOT/env/stack.env" >/dev/null
grep -F '# Generated by rtk-cloud sync-env. Do not edit manually.' "$ENV_ROOT/env/stack.env" >/dev/null
