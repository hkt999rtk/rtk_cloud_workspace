...
if [[ -e "$FAKE_RETRY_ROOT/cloud_env/staging/runtime/artifacts/capacity-experiments/cap-account-incomplete/logs/destroy-vms.log" ]]; then
...
grep -F 'destroy-vms called' \
	"$FAKE_RETRY_ROOT/cloud_env/staging/runtime/artifacts/capacity-experiments/cap-account-pass/logs/destroy-vms.log" >/dev/null
