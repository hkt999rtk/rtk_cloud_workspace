...
var deviceContractQualificationSpecs = []authorizationQualificationSpec{
	...
	},
	{
		...
		Targets: []authorizationQualificationTarget{
			...
			{Package: "./internal/app", GoTest: "TestCustomerPasswordLoginAllowsGlobalAccountsWithoutMemberships"},
			{Package: "./internal/app", GoTest: "TestAccountViewPreservesAccountSessionAndRotatedTokens"},
		...
		Assertions: map[string]map[string]string{
			...
			"REQ-CA-BFF-ENTITLEMENT-001": {"account_capabilities_projected": "PASS"},
			"REQ-CA-BFF-LOGIN-001":       {"global_account_login_allowed": "PASS"},
			"REQ-CA-BFF-RUNTIME-001":     {"runtime_metrics_exposed": "PASS"},
			"REQ-CA-BFF-SESSION-001":     {"shared_session_rotates_and_revokes": "PASS"},
	...
	},
	{
		...
		Assertions: map[string]map[string]string{
			...
			"REQ-LOGGER-ADOPTION-001":                {"shared_typed_logger_emits_json": "PASS"},
			"REQ-LOGGER-BOUNDARY-001":                {"logger_scope_and_collection_boundary_preserved": "PASS"},
			"REQ-LOGGER-CARDINALITY-001":             {"query_dimensions_remain_bounded": "PASS"},
			"REQ-LOGGER-DELIVERY-001":                {"cursor_advances_only_after_delivery": "PASS"},
			"REQ-LOGGER-DEPLOYMENT-001":              {"file_spool_recovers_queued_events": "PASS"},
			"REQ-LOGGER-FIELDS-001":                  {"service_envelope_fields_emitted": "PASS"},
			"REQ-LOGGER-HTTP-001":                    {"http_metadata_logged_without_secrets": "PASS"},
			"REQ-LOGGER-INTEGRATION-001":             {"ingest_and_query_contract_integrates": "PASS"},
			"REQ-LOGGER-QUERY-001":                   {"correlation_fields_are_queryable": "PASS"},
			"REQ-LOGGER-REDACTION-001":               {"unknown_sensitive_fields_are_redacted": "PASS"},
		},
		Workflows: map[string]map[string]string{
