...
func TestBillingStagingQualificationWorkflowIsControlledAndEvidenceBacked(t *testing.T) {
	...
	for _, required := range []string{
		...
		"RUNTIME_MEDIA_STORAGE_PREFIX",
		"lke-resolve-images",
		"get secret ghcr-pull",
		"GHCR_PULL_USERNAME",
		"GHCR_PULL_TOKEN",
		"LKE_VIDEO_CLOUD_IMAGE LKE_ACCOUNT_MANAGER_IMAGE LKE_BILLING_IMAGE",
		"LKE_CLOUD_ADMIN_IMAGE LKE_FRONTEND_IMAGE LKE_CLOUD_LOGGER_IMAGE",
		".operator.LKE_VIDEO_CLOUD_IMAGE",
		".operator.LKE_CLOUD_LOGGER_IMAGE",
		"resolved-images",
		...
		"rollout status deployment/billing-settlement-collector",
