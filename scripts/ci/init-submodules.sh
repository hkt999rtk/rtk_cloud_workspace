...
git config --local core.sshCommand "ssh -i $HOME/.ssh/id_ed25519_github_work -o IdentitiesOnly=yes"
git config --local --add url."git@github.com:".insteadOf "git@github-work.com:"
git config --local --add url."git@github.com:".insteadOf "git@github.com-work:"
