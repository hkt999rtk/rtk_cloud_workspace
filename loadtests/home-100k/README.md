...
The default profile uses `HOME100K_STAGE_WARM_UP=5m`,
`HOME100K_STAGE_STEADY=15m`, and `HOME100K_STAGE_COOL_DOWN=3m`, so the planned
window is 23 minutes per stage and 92 minutes across the 25K, 50K, 75K, and
