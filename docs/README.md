...
| [OTA pricing activation and service disclosure plan](design/ota-pricing-activation-and-disclosure-plan.md) | Supporting note | Approved OTA unit prices, UTC-month activation gaps, and login-only customer price disclosure for all services. |
...
| [billing-twd-currency-progress.md](billing-twd-currency-progress.md) | Progress | Track the TWD rate-card, Billing contract, code, migration, testing, and staging qualification work. |
| [billing-twd-currency-release-notes.md](billing-twd-currency-release-notes.md) | Release notes | Explain the TWD settlement boundary, proposed prices, migration order, and staging activation gate. |
