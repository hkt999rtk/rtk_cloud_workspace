...
type Config struct {
	...
	ClipUserPrivateKeyPath  string            `json:"-"`
	ClipServerPublicKeyPath string            `json:"-"`
	ClipPoissonSeed         int64             `json:"clip_poisson_seed,omitempty"`
	ClipUploadConcurrency   int               `json:"clip_upload_concurrency,omitempty"`
	ClipMixedNonClip        bool              `json:"clip_mixed_nonclip,omitempty"`
...
type ClipStorageMetrics struct {
	...
	ReadyUploads        int              `json:"ready_uploads"`
	CorrelatedReady     int              `json:"correlated_ready"`
	ControlPlaneBytes   int64            `json:"control_plane_body_bytes"`
	DirectPutBytes      int64            `json:"direct_object_put_bytes"`
	VerificationP95MS   int64            `json:"verification_p95_ms"`
	VerificationP99MS   int64            `json:"verification_p99_ms"`
	StageP95MS          map[string]int64 `json:"stage_p95_ms,omitempty"`
	MixedNonClipEnabled bool             `json:"mixed_non_clip_enabled,omitempty"`
	NonClipAttempts     int              `json:"non_clip_attempts,omitempty"`
	NonClipSuccesses    int              `json:"non_clip_successes,omitempty"`
	NonClipFailures     int              `json:"non_clip_failures,omitempty"`
	NonClipSuccessRate  float64          `json:"non_clip_success_rate,omitempty"`
}
