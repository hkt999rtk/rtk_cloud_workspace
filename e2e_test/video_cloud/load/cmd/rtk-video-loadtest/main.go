...
func runLoad(args []string) error {
	...
	fs.StringVar(&cfg.ClipUserPrivateKeyPath, "clip-user-private-key", cfg.ClipUserPrivateKeyPath, "P-256 user private key used to verify legacy clip download decryption")
	fs.StringVar(&cfg.ClipServerPublicKeyPath, "clip-server-public-key", cfg.ClipServerPublicKeyPath, "P-256 clip-server public key used to verify legacy clip download decryption")
	...
	fs.BoolVar(&cfg.ClipMixedNonClip, "clip-mixed-nonclip", cfg.ClipMixedNonClip, "require and independently gate concurrent non-clip traffic at 99.5% success")
